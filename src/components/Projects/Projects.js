...
const projectData = [
  ...
  },
  {
    ...
    description: "Workforce Chat enables you to leverage cutting-edge AI to its fullest potential. Seamlessly enhance your productivity with the power of AI & Automation working together as Artificial Employees.",
    demoLink: "https://ac-ai-chat.vercel.app/"
  },
  {
    imgPath: require("../../Assets/Projects/31.png"),
    isBlog: false,
    title: "RFQ Plus AI, A service of rTurner Consulting",
    role: 'AI Engineer, Fullstack-developer',
    description: "Our AI-Enabled Solution Qualifies the Bids So Your Team Never Misses a Winnable Opportunity. \n RFQplus gives you access to the latest AI technology. Using our system’s private AI workspaces, you can “chat” with the documents, ask specific questions and receive immediate, accurate and comprehensive answers…accelerating your understanding of the RFQ and giving you the data you need to make rapid decisions.",
    demoLink: "https://www.rfqplus.ai/"
  },
  {
    imgPath: require("../../Assets/Projects/32.png"),
    isBlog: false,
    title: "Bolna.ai - AI Voice Agent system Builder",
    role: 'AI/VOIP Engineer, Fullstack-developer',
    description: "Bolna.ai is an innovative platform designed for building and deploying enterprise-grade voice AI applications quickly and effectively. It allows developers to create end-to-end conversational voice agents that can connect to custom large language models (LLMs) and telephony systems. Originally developed from an AI interviewer bot aimed at helping users practice coding interviews, Bolna has evolved to address the orchestration challenges associated with voice AI features. Open Source Framework: Bolna is built as an open-source solution, enabling developers to customize and extend its capabilities easily. It has a strong community presence, with a notable fork-to-star ratio on GitHub, indicating significant interest and usage among developers. API Layer: To facilitate adoption, Bolna provides a comprehensive API layer that simplifies the integration of various components, making it user-friendly for developers. Voice Agent Capabilities: The platform supports various functionalities, including initiating phone calls using telephony providers like Twilio, transcribing conversations, and synthesizing responses using text-to-speech technologies. Integration with LLMs: Bolna can utilize multiple LLMs, such as OpenAI's models and others, to handle conversations effectively. No-Code/Low-Code Playground: For those less familiar with coding, Bolna offers a no-code/low-code playground where users can experiment with creating voice agents without xtensive programming knowledge. ",
    demoLink: "https://bolna.ai"
  },
  {
    ...
    <Container fluid className="project-section">
      ...
      <Container>
        <h1 className="project-heading">
          My Recent <strong className="purple">AI Works </strong>
        </h1>
        <p style={{ color: "white" }}>
